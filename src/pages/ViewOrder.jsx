...
export default function ViewOrder() {
  ...
  const statusOptions = {
    ...
    cutting: { label: 'Potong', color: 'bg-amber-100 text-amber-800 border-amber-300', icon: <Package size={16} /> },
    sewing: { label: 'Jahit', color: 'bg-orange-100 text-orange-800 border-orange-300', icon: <Package size={16} /> },
    finishing: { label: 'Finishing', color: 'bg-lime-100 text-lime-800 border-lime-300', icon: <Package size={16} /> },
    packing: { label: 'Packing', color: 'bg-emerald-100 text-emerald-800 border-emerald-300', icon: <Package size={16} /> },
    qc: { label: 'QC', color: 'bg-teal-100 text-teal-800 border-teal-300', icon: <Package size={16} /> },
